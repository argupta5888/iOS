...
class CoreDataManager {
  ...
  func insertPerson(name: String, ssn : Int16)->Person? {
    ...
    person.setValue("Music", forKeyPath: "hobby")
...
//Tightly coupled - persistentContainer can not be initialized by other client classes with different model, as it is tightly coupled with "PersonData".
//Not reusable - insert, update and delete only work with person, what if i have other entities and i want to perform insert, update and delete.
